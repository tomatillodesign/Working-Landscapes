...
function agentpress_google_fonts() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Lato:300,700|Roboto:700,300,400|Open+Sans:700,300,400', array(), CHILD_THEME_VERSION );
...
add_filter( 'genesis_seo_title', 'clb_custom_genesis_seo_title', 10, 1 );
function clb_custom_genesis_seo_title( $title ) {
	$title = '<h1 itemprop="headline" class="site-title"><a title="Working Landscapes – Home" href="' . get_bloginfo('url') . '"><span class="working">Working</span><span class="landscapes">Landscapes</span></a></h1>';
	return $title;
}
