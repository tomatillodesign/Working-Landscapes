...
* `GENESIS_EXTENDER_CMB_META_BOX_URL` does not define properly in WAMP/XAMP (Windows) (issue #31)
...
* Created 'genesis_extender_cmb_show_on' filter to define your own Show On Filters, props @billerickson
